            ...
            <CardContent>
                <ResponsiveContainer width="100%" height={350}>
                    <LineChart data={serviceTrends}>
                        ...
                        <YAxis yAxisId="left" stroke="#000000" fontSize={12} tickLine={false} axisLine={false} label={{ value: 'Services', angle: -90, position: 'insideLeft', fill: '#000000' }} />
                        <YAxis yAxisId="right" orientation="right" stroke="#000000" fontSize={12} tickLine={false} axisLine={false} label={{ value: 'Revenue ⟨₹⟩', angle: 90, position: 'insideRight', fill: '#000000' }} />
                        <Tooltip
                            contentStyle={{ backgroundColor: 'oklch(97.3% 0.071 103.193)', border: '1px solid oklch(72.3% 0.219 149.579)', borderRadius: '0.5rem'}}
                        ...
                        <Line yAxisId="left" type="monotone" dataKey="services" stroke="oklch(62.3% 0.214 259.815)" strokeWidth={2} name="Services" dot={{ fill: 'oklch(62.3% 0.214 259.815)', r:4 }} activeDot={{ r: 6 }} />
                        <Line yAxisId="right" type="monotone" dataKey="revenue" stroke="oklch(72.3% 0.219 149.579)" strokeWidth={2} name="Revenue" dot={{ fill: 'oklch(72.3% 0.219 149.579)', r:4 }} activeDot={{ r: 6 }} />
                    </LineChart>
                </ResponsiveContainer>
            </CardContent>
        </Card>
