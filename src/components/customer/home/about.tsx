            ...
            <header className="bg-gray-50 py-20 text-center">
                <div className="mx-auto max-w-3xl px-4">
                    <h1 className="mb-6 text-4xl font-bold heading-gradient">
                        About UrbanPestMaster
                    </h1>
                    <p className="text-xl text-gray-600">
                        Your trusted partner in pest control services since 2024.
                    </p>
                </div>
            </header>
            ...
            <article className="bg-[#edebe4] py-20">
                <div className="mx-auto max-w-3xl px-4">
                    ...
                    <p className="mb-6 text-gray-600">
                        Founded in 2024, UrbanPestMaster has been at the forefront of innovative pest
